...
## I'm **Tommy Grullón Contreras**


<div align='left'>
    <a href = "mailto:tcontreras.developer@gmail.com">
        <img src="https://img.shields.io/badge/-Gmail-%23333?style=for-the-badge&logo=gmail&logoColor=white" target="_blank">
    </a>
    <a href="https://www.linkedin.com/in/tommy-grull%C3%B3n-contreras/?locale=en_US" target="_blank">
...
```js
const tommcontreras11 = {
    code: ["Javascript", "Typescript", "C#", "C", "C++", "Java"],
    askMeAbout: ["Responsible", "Organized", "Fast Learning", "Goal Focused", "Self Taught", "Dedicated To Professional Growth"],
    technologies: {
        backend: {
            [js || ts]: ["Node", "Express", "GraphQL", "TypeORM"], //basic GraphQL
            asp: ["ASP.Net Core"]
        },
        frontend: {
            js: ["React", "Next.js", "Vanilla.js"],
            css: ["Bootstrap", "Tailwind", "Shadcn"] // beginner
        },
  ...
  <tbody>
    ...
    <tr valign="top">
     ...
     <td width="25%" align="center">
      ...
      <td width="25%" align="center">
        <br/><br/>
        <img height="64px" src="https://cdn.svgporn.com/logos/fastapi.svg">
      </td>
      <td width="25%" align="center">
        <br/><br/>
